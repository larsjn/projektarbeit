...
#         Tracer()() #this one triggers the debugger ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
        ...
        print(('Hinweis: Leider ist es relativ kompliziert auch "Punkt vor Strich" zubeacheten',
...
class Class_Create_New_Function(object) :
    ...
    def __init__(self,AIsDiscret): 
        ...
        self.RS_Frequenz = 'Siganl Frequnz' 
        # Help Texte
...
# ---------------------------------------------------- End def -----------------------------------------------------        
    ...
    def Create(self,AIsDiscrete): # Erstellt die Eingabemöglichkeit für die Anzahl der SubFunktionen
        ...
        # Butten um zum nächsten "Tab" zugehen und Eingaben zu übernehemen
...
# fctKont=Class_Create_New_Function(False)# Eine classe für beide Signaltypen True wenn diskretes Signal erstellt wird
# fctKont.Create(None)


# In[45]:

# fct=Class_Create_New_Function(True)# Eine classe für beide Signaltypen True wenn diskretes Signal erstellt wird
# fct.Create(None)


# In[35]:

# fctKont.FResultSignal.getYAt(1)
